...
func TestOpenWeatherMapFetchByLatLong(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := o.FetchByLatLong(tt.args.lat, tt.args.long)
			if err != nil {
				t.Fatal(err)
			}
